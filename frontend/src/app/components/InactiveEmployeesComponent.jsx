...
const InctiveEmployeesComponent = ({ contract }) => {
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        ...
        const formattedEmployees = InactiveEmployees.map((employee) => ({
          id: employee.id.toString(),
          name: employee.name,
          walletAddress: employee.walletAddress,
          salary: employee.salaryUSD.toString(),
          dateOfJoining: new Date(
            Number(employee.dateOfJoining) * 1000
          ).toLocaleDateString(),
          paymentDay: employee.salaryPaymentDay.toString(),
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center py-8">
        <div className="text-white">Loading employees data...</div>
      </div>
    );
  }
    ...
    <div className="mb-6">
      <div className="mb-4">
        <h3 className="text-xl font-bold text-white">
          inactive Employees ({employees.length})
        </h3>
      </div>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <button
                        ...
                        onClick={() =>
                          fetchEmployeeDetails(employee.walletAddress)
                        }
                      >
                        View Details
                      </button>
...
export default InctiveEmployeesComponent;
